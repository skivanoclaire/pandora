...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-white mb-2">Log Presensi</h1>
    <p class="text-pandora-muted">Log detail presensi pegawai termasuk waktu, lokasi, dan status validasi.</p>
</div>
...
<div class="bg-pandora-surface rounded-xl border border-white/5 p-8 text-center">
    <p class="text-pandora-muted">Modul log presensi sedang dalam tahap pengembangan.</p>
</div>
@endsection

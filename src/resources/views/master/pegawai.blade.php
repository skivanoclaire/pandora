...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-white mb-2">Master Data Pegawai</h1>
    <p class="text-pandora-muted">Data pegawai ASN yang terdaftar di lingkungan Pemerintah Provinsi Kalimantan Utara.</p>
</div>
...
<div class="bg-pandora-surface rounded-xl border border-white/5 p-8 text-center">
    <p class="text-pandora-muted">Modul master data pegawai sedang dalam tahap pengembangan.</p>
</div>
@endsection

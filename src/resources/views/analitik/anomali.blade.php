...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-white mb-2">Deteksi Anomali</h1>
    <p class="text-pandora-muted">Machine learning untuk mendeteksi pola tidak wajar pada data kehadiran pegawai.</p>
</div>
...
<div class="bg-pandora-surface rounded-xl border border-white/5 p-8 text-center">
    <p class="text-pandora-muted">Modul deteksi anomali sedang dalam tahap pengembangan.</p>
</div>
@endsection

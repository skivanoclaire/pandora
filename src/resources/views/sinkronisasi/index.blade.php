...
<div class="mb-6">
    ...
    <p class="text-pandora-muted">Konfigurasi dan monitoring sinkronisasi data kehadiran dari sistem SIMPEG.</p>
</div>
...
<div class="bg-pandora-surface rounded-xl border border-white/5 p-8 text-center">
    <p class="text-pandora-muted">Modul sinkronisasi data SIMPEG sedang dalam tahap pengembangan.</p>
</div>
@endsection
